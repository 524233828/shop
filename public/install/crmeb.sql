...
CREATE TABLE `eb_store_product`  (
  ...
  `browse` int(11) NULL DEFAULT 0 COMMENT '浏览量',
  `code_path` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '产品二维码地址(用户小程序海报)',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 97 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '附件管理表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `eb_system_config` VALUES (2, 'site_url', 'text', 1, '', 0, 'required:true,url:true', 100, 0, '\"http:\\/\\/datong.crmeb.net\"', '网站地址', '网站地址', 0, 1);
...
INSERT INTO `eb_system_config` VALUES (19, 'wechat_qrcode', 'upload', 2, '', 1, '', 0, 0, '\"\\/public\\/uploads\\/config\\/image\\/5c3d8f3405c48.jpg\"', '公众号二维码', '您的公众号二维码', 0, 1);
...
INSERT INTO `eb_system_config` VALUES (104, 'fast_number', 'text', 16, NULL, NULL, 'required:true,digits:true,min:1', 100, NULL, '\"10\"', '快速选择分类个数', '小程序首页配置快速选择分类个数', 0, 1);
INSERT INTO `eb_system_config` VALUES (105, 'bast_number', 'text', 16, NULL, NULL, 'required:true,digits:true,min:1', 100, NULL, '\"10\"', '精品推荐个数', '小程序首页配置精品推荐个数', 0, 1);
INSERT INTO `eb_system_config` VALUES (106, 'first_number', 'text', 16, NULL, NULL, 'required:true,digits:true,min:1', 100, NULL, '\"10\"', '首发新品个数', '小程序首页配置首发新品个数', 0, 1);
INSERT INTO `eb_system_config` VALUES (107, 'routine_index_logo', 'upload', 7, NULL, 1, NULL, NULL, NULL, '\"\\/public\\/uploads\\/config\\/image\\/5cb0448eed9cb.png\"', '小程序主页logo图标', '小程序主页logo图标', 0, 1);
...
-- Records of eb_user
-- ----------------------------
INSERT INTO `eb_user` VALUES (1, 'rt11555153424', 'e10adc3949ba59abbe56e057f20f883e', '等风来，随风去', 'https://wx.qlogo.cn/mmopen/vi_32/DYAIOgq83eqj70fHkbW9aJgp0KWMsp7cqOsgT16Syr8mWt9JkhngDWARibyNv5MBia3h8Y3BOkHBHdLiaX8Hq9J0w/132', NULL, 1555153423, '127.0.0.1', 1555153955, '127.0.0.1', 0.00, 0.00, 0, 1, 0, 0, 0, 'routine', 0, 0, 0);
...
-- ----------------------------
INSERT INTO `eb_user_level` VALUES (18, 95, 1, 1, 0, 1, 0, 1, '尊敬的用户天会亮、心会暖在2019-04-10 15:27:16成为了普通会员', 0, 0, 1554881236, 99);
INSERT INTO `eb_user_level` VALUES (19, 6, 1, 1, 0, 1, 0, 1, '尊敬的用户弱冠而立_在2019-04-10 17:17:46成为了普通会员', 0, 0, 1554887866, 99);
INSERT INTO `eb_user_level` VALUES (20, 46, 1, 1, 0, 1, 0, 1, '尊敬的用户张鹏飞在2019-04-10 17:18:46成为了普通会员', 0, 0, 1554887926, 99);
INSERT INTO `eb_user_level` VALUES (21, 127, 1, 1, 0, 1, 0, 1, '尊敬的用户路人甲在2019-04-10 17:39:57成为了普通会员', 0, 0, 1554889197, 99);
INSERT INTO `eb_user_level` VALUES (22, 4, 1, 1, 0, 1, 0, 1, '尊敬的用户徐斗明在2019-04-10 19:22:44成为了普通会员', 0, 0, 1554895364, 99);
INSERT INTO `eb_user_level` VALUES (23, 313, 1, 1, 0, 1, 0, 1, '尊敬的用户啊丶饭在2019-04-10 19:22:48成为了普通会员', 0, 0, 1554895368, 99);
INSERT INTO `eb_user_level` VALUES (24, 308, 1, 1, 0, 1, 0, 1, '尊敬的用户褚润林在2019-04-10 19:23:25成为了普通会员', 0, 0, 1554895405, 99);
INSERT INTO `eb_user_level` VALUES (25, 2, 1, 1, 0, 1, 0, 1, '尊敬的用户༄许のོ࿆༘荣耀࿐在2019-04-11 09:58:16成为了普通会员', 0, 0, 1554947896, 99);
INSERT INTO `eb_user_level` VALUES (27, 238, 1, 1, 0, 1, 0, 1, '尊敬的用户Mr .在2019-04-11 15:13:31成为了普通会员', 0, 0, 1554966811, 99);
INSERT INTO `eb_user_level` VALUES (28, 82, 1, 1, 0, 1, 0, 1, '尊敬的用户等风来，随风去在2019-04-11 16:46:30成为了普通会员', 0, 0, 1554972390, 99);
INSERT INTO `eb_user_level` VALUES (29, 312, 1, 1, 0, 1, 0, 1, '尊敬的用户Ricky คิดถึง在2019-04-12 12:53:38成为了普通会员', 0, 0, 1555044818, 99);
INSERT INTO `eb_user_level` VALUES (30, 180, 1, 1, 0, 1, 0, 1, '尊敬的用户镇哥在2019-04-12 21:15:05成为了普通会员', 0, 0, 1555074905, 99);
INSERT INTO `eb_user_level` VALUES (31, 27, 1, 1, 0, 1, 0, 1, '尊敬的用户梁海涛在2019-04-13 10:29:30成为了普通会员', 0, 0, 1555122570, 99);
